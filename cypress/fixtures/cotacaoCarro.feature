Feature: Solicitar uma cotação de suguro de carro
    ...
    Scenario Outline: Enviar solicitação de orçamento de seguro de carro
        ...
        Examples:
            ...
            | Porche | 200               | 05/12/2018        | 5             | Petrol  | 25000     | 123                | 200            | Peter      | Williams | 05/08/1989 | Great Street number 2 | Albania | 5555    | Test City | Employee   | 05/05/2022 | Bonus 5     | No Coverage     | Yes         | test@test.com.br | 55819898989 | teste    | Test123  | Test123          |